...
/* package HeyChess-0.1.0.0 */
#ifndef VERSION_HeyChess
#define VERSION_HeyChess "0.1.0.0"
#endif /* VERSION_HeyChess */
#ifndef MIN_VERSION_HeyChess
#define MIN_VERSION_HeyChess(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_HeyChess */
...
#define CURRENT_COMPONENT_ID "HeyChess-0.1.0.0-inplace-HeyChess"
